    ...
    <div className="assignment-section full-screen">
      ...
      <div className="assignment-card button-group-horizontal">
        <button
          ...
          style={{
            backgroundColor: '#2c3e50', // Updated color
            color: 'white',
            border: 'none',
            padding: '10px 20px',
            margin: '10px',
          ...
          onClick={() => navigate('/assignment3/fd-rd-portal')}
        >
        ...
        <button
          ...
          onClick={() => navigate('/assignment3/dashboard')}
        >
        ...
        <button
          ...
          onClick={() => navigate('/assignment3/investments')}
        >
